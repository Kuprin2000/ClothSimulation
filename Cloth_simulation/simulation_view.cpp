...
void SimulationView::renderInternal(int vertices_count, int triangles_count, const AlignedVector::AlignedVector<glm::vec3>& coords, const AlignedVector::AlignedVector<glm::uvec3>& indices,
...
void SimulationView::renderInternal(int vertices_count, int triangles_count, const AlignedVector::AlignedVector<glm::vec3>& coords, const AlignedVector::AlignedVector<glm::vec3>& normals, DrawMode draw_mode, int vbo, int ebo) const
{
	const uint64_t u_vertices_count = (uint64_t)vertices_count;
	const uint64_t bytes_length = u_vertices_count * 3u * sizeof(float);
...
void SimulationView::renderInternal(int vertices_count, int triangles_count, const AlignedVector::AlignedVector<glm::vec3>& coords, const AlignedVector::AlignedVector<glm::uvec3>& indices, DrawMode draw_mode, int vbo, int ebo) const
{
	const uint64_t u_vertices_count = (uint64_t)vertices_count;
	const uint64_t bytes_length = u_vertices_count * 3u * sizeof(float);
