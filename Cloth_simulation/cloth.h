...
public:
	...
	Cloth(const AlignedVector::AlignedVector<glm::vec3>& coords, const AlignedVector::AlignedVector<glm::uvec3>& indices, const AlignedVector::AlignedVector<float>& opposite_masses,
	...
	_NODISCARD AlignedVector::AlignedVector<glm::vec3>& getCoords()
	{
		return m_vertices_data.m_coords;
	}

	_NODISCARD const AlignedVector::AlignedVector<glm::vec3>& getCoords() const
	{
		return m_vertices_data.m_coords;
	}
	...
	_NODISCARD AlignedVector::AlignedVector<glm::vec3>& getTestCoords()
	{
	...
	void setTestCoords(const AlignedVector::AlignedVector<glm::vec3>& test_coords)
	{
	...
	_NODISCARD const AlignedVector::AlignedVector<glm::uvec3>& getIndices() const
	{
	...
	_NODISCARD const AlignedVector::AlignedVector<glm::vec3>& getNormals() const
	{
		return m_vertices_data.m_normals;
	}

	void setNormals(const AlignedVector::AlignedVector<glm::vec3>& normals)
	{
	...
	_NODISCARD const AlignedVector::AlignedVector<float>& getOppositeMasses() const
	{
	...
	_NODISCARD AlignedVector::AlignedVector<glm::vec3>& getSpeeds()
	{
	...
	_NODISCARD const AlignedVector::AlignedVector<uint32_t>& getHostOrOriginalVertices() const
	{
	...
	_NODISCARD const AlignedVector::AlignedVector<uint8_t>& getTrianglesPrimitivesOwnership() const
	{
...
private:
	struct
	{
		AlignedVector::AlignedVector<glm::vec3> m_coords;			// coordinates of real and phantom vertices
		AlignedVector::AlignedVector<glm::vec3> m_test_coords;		// test coordinates of real and phantom vertices
		AlignedVector::AlignedVector<glm::uvec3> m_indices;		// indices of real vertices
		AlignedVector::AlignedVector<glm::vec3> m_normals;	   		// normals of real vertices

		AlignedVector::AlignedVector<float> m_opposite_masses; 	// opposite masses of real vertices
		AlignedVector::AlignedVector<glm::vec3> m_speeds;	  		// speeds of real vertices
		...
		AlignedVector::AlignedVector<uint32_t> m_host_and_original_vertices;

		AlignedVector::AlignedVector<uint8_t> m_primitives_ownership; // shows which vertices and edges each triangle owns
