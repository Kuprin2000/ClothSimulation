...
public:
	...
	Collider(const AlignedVector::AlignedVector<glm::vec3>& coords, const AlignedVector::AlignedVector<glm::uvec3>& indices, float friction_coefficient) : m_coords(coords), m_indices(indices)
	{
...
private:
	...
	AlignedVector::AlignedVector<glm::vec3> m_normals;
	AlignedVector::AlignedVector<glm::uvec3> m_indices;
	AlignedVector::AlignedVector<uint8_t> m_primitives_ownership;
