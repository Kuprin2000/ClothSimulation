...
AlignedVector::AlignedVector<uint8_t> PrimitivesOwnershipUtils::generatePrimitivesOwnership(const AlignedVector::AlignedVector<glm::uvec3>& indices)
{
	...
	// result array
	AlignedVector::AlignedVector<uint8_t> result((int)indices.size());
