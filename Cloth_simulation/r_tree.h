...
public:
	...
	void insertVertices(const AlignedVector::AlignedVector<glm::vec3>& vertices_coords, int first_vertex_index, RTree::ObjectType object_type, float gap);

	void insertMovingVertices(const AlignedVector::AlignedVector<glm::vec3>& old_vertices_coords, const AlignedVector::AlignedVector<glm::vec3>& new_vertices_coords, int first_vertex_index, RTree::ObjectType object_type, float gap);

	void insertTriangles(const AlignedVector::AlignedVector<glm::vec3>& vertices_coords, const AlignedVector::AlignedVector<glm::uvec3>& vertices_indices,
	...
	void insertMovingTriangles(const AlignedVector::AlignedVector<glm::vec3>& old_vertices_coords, const AlignedVector::AlignedVector<glm::vec3>& new_vertices_coords,
		const AlignedVector::AlignedVector<glm::uvec3>& vertices_indices, int first_triangle_index, RTree::ObjectType object_type, float gap);
